...
def generer_bulletin_pdf(bulletin):
    ...
    # === PIED DE PAGE (positions fixes depuis le bas) ===
    footer_top = 3.0*cm  # limite haute du pied de page
    ...
    p.setFillColor(colors.black)
    # Trait de séparation au-dessus du pied de page
    ...
    sig_y = footer_top + 0.3*cm  # juste au-dessus du trait
